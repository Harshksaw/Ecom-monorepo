    ...
    <Wrapper>
      <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-lg font-semibold text-gray-800">1. What types of jewelry do you sell?</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800">2. Where is your store located?</h2>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800">3. What are your working hours?</h2>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800">4. Can I contact you for inquiries?</h2>
            <p className="text-gray-700 mt-1">
              Absolutely! Feel free to call us at{' '}
              <a href="tel:+919782441137" className="text-gray-700 hover:underline">+91 97824 41137</a>{' '}
              or email us at{' '}
              <a href="mailto:shrinanugems111@gmail.com" className="text-gray-700 hover:underline">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800">5. Do you offer gemstone services?</h2>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800">6. Is customization available for jewelry orders?</h2>
            <p className="text-gray-700 mt-1">
