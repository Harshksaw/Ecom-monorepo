  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const razorpayOptions = {
        ...
        amount: total * 100, // Amount in paise (multiply by 100 for INR)
        currency: 'INR',
        name: 'Shri Nanu Gems & Jewelers',
        description: `Order #${orderData.orderId}`,
        image: '/logo.png', // Optional: Add your logo URL
        order_id: orderData.razorpayOrderId, // Order ID generated by Razorpay
        handler: async (response: any) => {
          // Handle successful payment
          const paymentResponse = await fetch(`${API_URL}/payments/verify-razorpay`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
        ...
        prefill: {
          ...
          contact: defaultShippingAddress?.phone || ''
        },
        theme: {
          color: '#3399cc'
        }
