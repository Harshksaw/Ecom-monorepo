# ecom - Beauty & Cosmetics – Full Stack eCommerce Web Application + Admin Panel


![ecom Image Banner](https://i.ibb.co/yBHL1wj/beauty-cosmetics.png)

ecom Beauty & Cosmetics is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
- **Authentication:** ecom includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Typescript + Next.js App Directory:** ecom leverages TypeScript in combination with Next.js, enhancing code reliability and maintainability.
...
- **Responsive Layout Design:** ecom is fully responsive across all devices, providing a seamless experience for your customers.
...
- **Flexible and Multi-Purpose:** ecom is versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** ecom provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
1. Clone the repository:
   ...
   ```bash
   https://github.com/Hamed-Hasan/ecom-Beauty-and-Cosmetics-ecommerce-client.git
   ```
...
[ecom Client Side Live Link](https://ecom-beauty-cosmetics-ecommerce.vercel.app)

## Server Side Live Link

[ecom Server Side Live Link](https://ecom-backend.vercel.app)

## Client Side Repo

[ecom Client Side Repo](https://github.com/Hamed-Hasan/ecom-Beauty-and-Cosmetics-ecommerce-client.git)

## Server Side Repo

[ecom Server Side Repo](https://github.com/Hamed-Hasan/ecom-Beauty-and-Cosmetics-ecommerce-backend.git)
...
We hope you find ecom to be a powerful and effective solution for your eCommerce needs. Should you encounter
